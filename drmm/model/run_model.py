...
if len(sys.argv) < 6:
    print('Needs 5 arguments - 1. run name, 2. train pair file (fold), 3. train histogram file, 4. test file (fold), '
...
if not os.path.exists('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/'):
    os.makedirs('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/')
...
model.save_weights('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/' + run_name + '.weights')
...
if not os.path.exists('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/results/'):
    os.makedirs('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/results/')
with open('/home/suchana/PycharmProjects/causalIR/neural-ranking-drmm/neural-ranking/model_trec_sigmoid/results/' + run_name + ".result", 'w') as outFile:
